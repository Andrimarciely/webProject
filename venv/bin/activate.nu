...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/andri/Documentos/repositorioSisTCC/webProject/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/andri/Documentos/repositorioSisTCC/webProject/venv/bin/deactivate.nu'
